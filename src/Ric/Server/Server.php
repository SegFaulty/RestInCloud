...
class Ric_Server_Server {
	...
	const VERSION = '0.7.0'; // dont forget to change the client(s) version | if you break api backward compatibility inc the major version | all clients will fail until they updated
